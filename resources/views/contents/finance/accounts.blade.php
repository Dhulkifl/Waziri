                ...
                <div class="row min-vh-50 ">
                    <div class="col-7 order-xxl-3">
                        <div class="card" id="runningProjectTable"
                            data-list='{"valueNames":["#","accounts","types","openings","descriptions"]}'>
                                    ...
                                    <table
                                        ...
                                        <thead class="bg-light">
                                            <tr class="text-800">
                                                ...
                                                <th class="sort" data-sort="accounts">{{ __('translations.account') }}
                                                </th>
                                                <th class="sort" data-sort="types">{{ __('translations.type') }}</th>
                                                <th class="sort text-center" data-sort="openings">
                                                    {{ __('translations.openingBalance') }}</th>
                                                <th class="sort text-center" data-sort="descriptions">
                                                    {{ __('translations.description') }}</th>
                                                ...
                                                @if ($account->account_type != 'Assets')
                                                    <tr>
                                                        ...
                                                        <td class="align-middle"
                                                            ...
                                                            <span
                                                                class="fs--1 mb-0  fw-semi-bold text-900 accounts">{{ $account->account_name }}</span>
                                                        </td>
                                                        ...
                                                        <td class="align-middle text-center"
                                                            ...
                                                            <span
                                                                class="fs--1 mb-0  fw-semi-bold text-900 openings">{{ $account->opening_balance }}</span>
                                                        </td>

                                                        <td class="align-middle text-center"
                                                            description="{{ $account->description }}">
                                                            <span
                                                                class="fs--1 mb-0 fw-semi-bold text-900 descriptions">{{ $account->description }}</span>
                                                        </td>
                                                        <td class="align-middle text-center"
                                                            account_id="{{ $account->id }}">
                                                            <span
                                                                class="fs--1 mb-0 fw-semi-bold  far fa-edit fs-2 text-warning edit_account"></span>
                                                        </td>
                                                    </tr>
                                                @endif
                                            @endforeach
                            ...
                            <div class="col-lg-12 col-xl-9 col-xxl-6">
                                <div class="card">
                                    <div class="card-header bg-circle-shape bg-shape text-center p-2"><a
                                            class="font-sans-serif fw-bolder fs-4 z-index-1 position-relative link-light light">{{ __('translations.newAccount') }}</a>
                                    </div>
                                        ...
                                        <form class="needs-validation" novalidate>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="split-name">{{ __('translations.accountName') }}</label>
                                                <input class="form-control" id="account_name" type="text"
                                                    name="account_name" autocomplete="on" required />
                                            </div>
                                            ...
                                            <div class=" mb-3">
                                                ...
                                                <select class="form-select" id="account_type" name="account_type"
                                                    required>
                                                    <option value="Income/Fees">{{ __('translations.incomeFees') }}
                                                    </option>
                                                    <option value="Expense">{{ __('translations.expense') }}</option>
                                                    <option value="Expense/Salary">
                                                        {{ __('translations.expense') }}/{{ __('translations.salary') }}
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="split-name">{{ __('translations.openingBalance') }} </label>
                                                <input class="form-control" type="text" id="opening_balance"
                                                    value="0" name="opening_balance" autocomplete="on" />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="split-name">{{ __('translations.description') }}</label>
                                                <input class="form-control" type="text" id="description"
                                                    value=" " name="description" autocomplete="on" />
                                            </div>
