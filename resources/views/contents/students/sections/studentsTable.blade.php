<div class="col-xxl-9 col-md-12">
    <div class="card z-index-1" id="recentPurchaseTable"
        data-list='{"valueNames":["#","student_id","name","father_name","last_name","phone","address","status"],"page":10,"pagination":true}'>
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-6 col-sm-auto d-flex gap-2 align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"> {{ __('translations.students') }} </h5>
        ...
        <div class="card-body px-0 py-0">
            <div class="table-responsive scrollbar">
                <table class="table table-sm fs-rtl fw-semi-bold mb-0 overflow-hidden" style="font-family: 'Calibri'">
                    <thead class="bg-200 text-900">
                        <tr>
                            <th class="sort pe-1 align-middle white-space-nowrap" data-sort="#">#</th>
                            <th class="sort pe-1 align-middle white-space-nowrap text-center" data-sort="student_id">
                                {{ __('translations.id') }}</th>
                            <th class="sort pe-1 align-middle white-space-nowrap text-center" data-sort="name">
                    ...
                    <tbody class="list" id="table-purchase-body">
                        @foreach ($students as $student)
                            <tr class="btn-reveal-trigger">
                                ...
                                <th class="align-middle white-space-nowrap text-center student_id">
                                    ST-0{{ $student->id }}</th>
                                <td class="align-middle white-space-nowrap text-center name">{{ $student->name }}</td>
                                ...
                                <td class="align-middle white-space-nowrap text-center phone">{{ $student->phone }}
                                </td>
                                <td class="align-middle white-space-nowrap text-center address">{{ $student->address }}
                                </td>
                                <td class="align-middle white-space-nowrap text-center status">
                                    <span
                                        class="badge badge fs-rtl rounded-pill px-3 @if ($student->status == 'Active') badge-soft-success @else badge-soft-warning @endif">
                                        {{ __('translations.' . $student->status) }}
                                    </span>
                                </td>
